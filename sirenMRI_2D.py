...
# NEW: physics informed weight
parser.add_argument("--lambda_phys", type=float, default=0.0, help="Weight for physics-informed loss")
...
for i in range(sz):
    ...
    if 'train' in args.operation:
        ...
        # Set up training  (ADD lambda_phys pass-through)
        trainer = Trainer(func_rep, lr=args.learning_rate, lambda_phys=args.lambda_phys)
